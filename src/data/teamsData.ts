...
import { TeamInfo } from '../types/index';
...
export const TEAMS_INFO: Record<string, TeamInfo> = {
  argentina: {
    name: "Argentina",
    banderaIcono: "/assets/img/icons/banderaLogoA.jpg",
    ...
    banderaPrincipal: "/assets/img/db/banderaAlbum/banderaArg.jpg"
  },
  brasil: {
    name: "Brasil",
    banderaIcono: "/assets/img/icons/banderaLogoB.jpg",
    ...
    banderaPrincipal: "/assets/img/db/banderaAlbum/banderaBra.jpg"
  },
  francia: {
    name: "Francia",
    banderaIcono: "/assets/img/icons/banderaLogoF.jpg",
    ...
    banderaPrincipal: "/assets/img/db/banderaAlbum/banderaFra.jpg"
  },
};
